		    ...
		    <div className="w-full flex items-center justify-between px-6">
		        ...
		        <div className="topbar-item hs-dropdown [--placement:bottom-right] relative inline-flex">
		            ...
		            <div className="hs-dropdown-menu" role="menu">
		                {/*languages.map((lang, i) => <Link key={i} href="#" className="flex items-center gap-x-3.5 py-1.5 px-3 text-default-600 hover:bg-default-150 rounded font-medium">
		        ...
		        <div className="hs-dropdown-menu max-w-100 p-0">
		            ...
		            <SimpleBar className="h-80">
		                {tabs.map((tab, i) => <div key={i} id={tab.id} className={tab.active ? '' : 'hidden'}>
		                    {notifications[tab.id]?.map((n, j) => <Link key={j} href="#" className="flex gap-3 p-4 items-start hover:bg-default-150">
		            ...
		            <div className="p-2">
		                ...
		                <div className="border-t border-default-200 -mx-2 my-2"></div>
		                    ...
		                    <div className="flex flex-col gap-y-1">
		                        ...
		                        : <Link key={i} href={item.to || '#!'} className="flex items-center gap-x-3.5 py-1.5 px-3 text-default-600 hover:bg-default-150 rounded font-medium">
		                        {item.icon}
		                        {item.label}
